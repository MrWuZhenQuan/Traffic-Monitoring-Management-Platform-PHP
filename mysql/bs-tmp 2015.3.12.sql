...
CREATE TABLE IF NOT EXISTS `tmp_device` (
...
INSERT INTO `tmp_device` (`id`, `user_id`, `name`, `starttime`, `created_at`, `updated_at`) VALUES
(1, 0, 'a', 0, 0, 0),
(2, 0, 'b', 0, 0, 0),
(3, 0, 'c', 0, 0, 0);
...
--
-- 表的结构 `tmp_traffic_data`
--

CREATE TABLE IF NOT EXISTS `tmp_traffic_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `outofman` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- 转存表中的数据 `tmp_traffic_data`
--

INSERT INTO `tmp_traffic_data` (`id`, `period`, `visiters`, `device_id`, `created_at`, `updated_at`, `outofman`) VALUES
(1, 1, 123, 1, '2015-03-12 15:24:49', '0000-00-00 00:00:00', 0),
(2, 2, 456, 2, '2015-03-12 15:24:49', '0000-00-00 00:00:00', 0),
(3, 3, 785, 3, '2015-03-12 11:30:44', '0000-00-00 00:00:00', 0),
(4, 4, 987, 1, '2015-03-12 11:30:44', '0000-00-00 00:00:00', 0),
(5, 24, 354, 2, '2015-03-12 11:30:44', '0000-00-00 00:00:00', 0),
(6, 13, 258, 1, '2015-03-12 11:30:44', '0000-00-00 00:00:00', 0),
(7, 0, 123, 1, '2015-03-11 11:06:03', '0000-00-00 00:00:00', 0);
